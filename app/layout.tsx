...
export const metadata: Metadata = {
  title: "Scheduled Digest - Workflow DevKit Example",
  description:
    "Demonstrates collecting events over a time window and batch-processing them with sleep() in Workflow DevKit",
};
