...
function CodePane({
  ...
  const gutterMarkMap = useMemo(() => new Map(Object.entries(gutterMarks).map(([k, v]) => [Number(k), v])), [gutterMarks]);
...
export type DigestCodeWorkbenchProps = {
  workflowCode: string;
...
export function DigestCodeWorkbench({
  workflowCode,
  workflowHtmlLines,
  workflowActiveLines,
  workflowGutterMarks,
  ...
  return (
    <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
      <CodePane
        ...
        filename="workflows/scheduled-digest.ts"
